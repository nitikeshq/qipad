...
export const userTypeEnum = pgEnum('user_type', ['business_owner', 'investor', 'individual', 'agent', 'admin']);
...
export const companies = pgTable("companies", {
  ...
  employeeCount: integer("employee_count"), // Employee count as integer to match database
